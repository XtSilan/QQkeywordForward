...
function SystemSettingsPage({ onError }: { onError: (message: string) => void }) {
  ...
  const [duplicateCooling, setDuplicateCooling] = useState({ threshold: 3, cooldown_minutes: 10 });
